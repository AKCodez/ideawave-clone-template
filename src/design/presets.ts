...
export const PRESETS = {
  editorial: {
    ...
    composition: { hero: "ledger", bento: "airy", stats: "rows" },
    credit,
    meta,
  },
  luminous: {
    ...
    composition: { hero: "stage", bento: "dense", stats: "numerals" },
    credit,
    meta,
  },
  brutal: {
    ...
    composition: { hero: "split", bento: "dense", stats: "rows" },
    credit,
    meta,
  },
  craft: {
    ...
    composition: { hero: "split", bento: "airy", stats: "numerals" },
    credit,
    meta,
  },
  "editorial-light": {
    ...
    imagery: { rules: ["Typography over photography", "Show real paragraphs, never lorem"] },
    composition: { hero: "stage", bento: "airy", stats: "rows" },
    credit,
    meta,
  },
  "luminous-light": {
    ...
    imagery: { rules: ["Product frames over stock photos", "Charts show seeded data, never fake spikes"] },
    composition: { hero: "ledger", bento: "dense", stats: "numerals" },
    credit,
    meta,
  },
